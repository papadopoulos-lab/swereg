...
S7 method that truncates weights at specified quantiles. Wraps
...
- trial:
  ...
  A \[TTETrial\] object with trial level data and weight columns.

- ...:

  Method arguments: \`weight_cols\` (character vector or NULL),
...
\[tte_truncate_weights()\] for the underlying function
