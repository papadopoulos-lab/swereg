...
- [`RegistryStudy$register_trim()`](#method-RegistryStudy-register_trim)
...
### `RegistryStudy$register_trim()`

Register the trim function (phase 1b). A study may register at most one.
...
#### Usage
    ...
    RegistryStudy$register_trim(fn)
...
### `RegistryStudy$randvars_hashes()`

Return one hash per registered phase-3 step, named by step name and in
registration order.

Each step's hash folds in four inputs. They are the step function's own
