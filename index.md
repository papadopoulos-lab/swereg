...
For the full manual walkthrough see
...
8.  [`vignette("skeleton-create")`](https://papadopoulos-lab.github.io/swereg/articles/skeleton-create.md)
    – build a skeleton by hand with
    ...
    derived variables.
9.  [`vignette("skeleton-analyze")`](https://papadopoulos-lab.github.io/swereg/articles/skeleton-analyze.md)
    – collapse to person-years and run analyses on the finished
    skeleton.
