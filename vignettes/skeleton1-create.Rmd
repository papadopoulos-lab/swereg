...
fake_annual_family <- data.table::copy(swereg::fake_annual_family)
...
fake_prescriptions <- data.table::copy(swereg::fake_prescriptions)
...
fake_cod <- data.table::copy(swereg::fake_cod)
