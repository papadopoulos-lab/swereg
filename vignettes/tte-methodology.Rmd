...
| Cloning + censoring | Hernán 2016 | Not used. Our per-band comparator draw is an alternative to cloning that is computationally more efficient for large registries. |
