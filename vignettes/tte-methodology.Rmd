...
| Cloning + censoring | Hernán 2016 | Not used. Our per-band comparator draw is an alternative to cloning that is computationally more efficient for large registries. The draw is exactly matched on the `period_width`-week entry band, and on nothing else. |
