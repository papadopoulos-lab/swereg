...
1. **"Creating the skeleton"** - Build the time grid, integrate registry data, and derive variables
2. **"Analysing the skeleton"** - Collapse to the right granularity and run analyses
