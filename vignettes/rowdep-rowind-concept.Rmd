---
title: "Understanding rowdep and rowind Variables"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Understanding rowdep and rowind Variables}
...
The most common transformation finds the first time a condition is TRUE and extracts a value from that time point.
...
For variables that don't require complex conditions:
...
## Pattern 3: Value at Specific Time

Capture a variable's value at a specific time point:
