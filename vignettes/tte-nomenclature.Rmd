...
swereg uses a **per-band stratified comparator draw**. Within each enrollment band, it takes a seeded random sample of comparator individuals. The sample size is the stated ratio (e.g. 1:5) to the count of intervention individuals. The draw is therefore exactly matched on the `period_width`-week entry band, and not on the week. It is matched on nothing else. It is a design choice for computational efficiency on a large registry dataset.
