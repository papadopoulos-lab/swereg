---
title: "Basic Workflow: Introduction to swereg"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Basic Workflow: Introduction to swereg}
...
The skeleton concept follows a structured approach where a time-based framework (the skeleton structure) is created first, followed by the systematic integration of registry data.
