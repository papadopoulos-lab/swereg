---
title: "Advanced swereg Workflow: From skeleton1_create to skeleton3_analyze"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Advanced swereg Workflow: From skeleton1_create to skeleton3_analyze}
...
1. **skeleton1_create**: Raw data integration with memory-efficient batching
2. **skeleton2_clean**: Data cleaning and derived variable creation
3. **skeleton3_analyze**: Analysis-ready dataset extraction

This approach is designed for large Swedish registry studies with hundreds of thousands of individuals.
...
This workflow scales to handle Swedish national registry data with millions of individuals while maintaining computational efficiency and reproducibility.
