...
fake_demographics <- data.table::copy(swereg::fake_demographics)
...
for(year in 1995:2005) {
  ...
  annual_data_year <- data.table::copy(swereg::fake_annual_family)
  swereg::make_lowercase_names(annual_data_year)
...
fake_inpatient_diagnoses <- data.table::copy(swereg::fake_inpatient_diagnoses)
fake_outpatient_diagnoses <- data.table::copy(swereg::fake_outpatient_diagnoses)
...
This cookbook demonstrates survival analysis with time-varying covariates using the swereg skeleton framework.