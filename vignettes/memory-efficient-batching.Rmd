---
title: "Memory-efficient batching"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Memory-efficient batching}
...
# Apply make_lowercase_names to all datasets in the list
swereg::make_lowercase_names(large_data_files[["fake_demographics"]])
swereg::make_lowercase_names(large_data_files[["fake_annual_family"]])
swereg::make_lowercase_names(large_data_files[["fake_inpatient_diagnoses"]])
swereg::make_lowercase_names(large_data_files[["fake_outpatient_diagnoses"]])
swereg::make_lowercase_names(large_data_files[["fake_prescriptions"]])
swereg::make_lowercase_names(large_data_files[["fake_cod"]])
